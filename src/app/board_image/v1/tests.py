...
class BoardImageListAPITest(APITestCase):
    MODEL = BoardImage
    PATH = "/v1/board_image/"
...
class BoardImageCreateAPITest(APITestCase):
    MODEL = BoardImage
    PATH = "/v1/board_image/"
...
class BoardImageRetrieveAPITest(APITestCase):
    MODEL = BoardImage
    PATH = "/v1/board_image/{id}/"
...
class BoardImageUpdateAPITest(APITestCase):
    MODEL = BoardImage
    PATH = "/v1/board_image/{id}/"
...
class BoardImageDestroyAPITest(APITestCase):
    MODEL = BoardImage
    PATH = "/v1/board_image/{id}/"
