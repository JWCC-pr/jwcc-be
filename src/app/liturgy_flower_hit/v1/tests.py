...
class LiturgyFlowerHitListAPITest(APITestCase):
    MODEL = LiturgyFlowerHit
    PATH = "/v1/liturgy_flower_hit/"
...
class LiturgyFlowerHitCreateAPITest(APITestCase):
    MODEL = LiturgyFlowerHit
    PATH = "/v1/liturgy_flower_hit/"
...
class LiturgyFlowerHitRetrieveAPITest(APITestCase):
    MODEL = LiturgyFlowerHit
    PATH = "/v1/liturgy_flower_hit/{id}/"
...
class LiturgyFlowerHitUpdateAPITest(APITestCase):
    MODEL = LiturgyFlowerHit
    PATH = "/v1/liturgy_flower_hit/{id}/"
...
class LiturgyFlowerHitDestroyAPITest(APITestCase):
    MODEL = LiturgyFlowerHit
    PATH = "/v1/liturgy_flower_hit/{id}/"
