...
class WeeklyBulletinListAPITest(APITestCase):
...
class WeeklyBulletinCreateAPITest(APITestCase):
    MODEL = WeeklyBulletin
    PATH = "/v1/weekly_bulletin/"
...
class WeeklyBulletinRetrieveAPITest(APITestCase):
    MODEL = WeeklyBulletin
    PATH = "/v1/weekly_bulletin/{id}/"
...
class WeeklyBulletinUpdateAPITest(APITestCase):
    MODEL = WeeklyBulletin
    PATH = "/v1/weekly_bulletin/{id}/"
...
class WeeklyBulletinDestroyAPITest(APITestCase):
    MODEL = WeeklyBulletin
    PATH = "/v1/weekly_bulletin/{id}/"
