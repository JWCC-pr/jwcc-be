...
class PriestHistoryListAPITest(APITestCase):
    MODEL = PriestHistory
...
class PriestHistoryCreateAPITest(APITestCase):
    MODEL = PriestHistory
    PATH = "/v1/priest_history/"
...
class PriestHistoryRetrieveAPITest(APITestCase):
    MODEL = PriestHistory
    PATH = "/v1/priest_history/{id}/"
...
class PriestHistoryUpdateAPITest(APITestCase):
    MODEL = PriestHistory
    PATH = "/v1/priest_history/{id}/"
...
class PriestHistoryDestroyAPITest(APITestCase):
    MODEL = PriestHistory
    PATH = "/v1/priest_history/{id}/"
