...
class WeeklyBulletinEditorialFileListAPITest(APITestCase):
    ...
    PATH = "/v1/weekly_bulletin_editorial_file/"
...
class WeeklyBulletinEditorialFileCreateAPITest(APITestCase):
    MODEL = WeeklyBulletinEditorialFile
    PATH = "/v1/weekly_bulletin_editorial_file/"
...
class WeeklyBulletinEditorialFileRetrieveAPITest(APITestCase):
    MODEL = WeeklyBulletinEditorialFile
    PATH = "/v1/weekly_bulletin_editorial_file/{id}/"
...
class WeeklyBulletinEditorialFileUpdateAPITest(APITestCase):
    MODEL = WeeklyBulletinEditorialFile
    PATH = "/v1/weekly_bulletin_editorial_file/{id}/"
...
class WeeklyBulletinEditorialFileDestroyAPITest(APITestCase):
    MODEL = WeeklyBulletinEditorialFile
    PATH = "/v1/weekly_bulletin_editorial_file/{id}/"
