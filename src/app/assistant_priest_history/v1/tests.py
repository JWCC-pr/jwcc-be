...
class AssistantPriestHistoryListAPITest(APITestCase):
...
class AssistantPriestHistoryCreateAPITest(APITestCase):
    MODEL = AssistantPriestHistory
    PATH = "/v1/assistant_priest_history/"
...
class AssistantPriestHistoryRetrieveAPITest(APITestCase):
    MODEL = AssistantPriestHistory
    PATH = "/v1/assistant_priest_history/{id}/"
...
class AssistantPriestHistoryUpdateAPITest(APITestCase):
    MODEL = AssistantPriestHistory
    PATH = "/v1/assistant_priest_history/{id}/"
...
class AssistantPriestHistoryDestroyAPITest(APITestCase):
    MODEL = AssistantPriestHistory
    PATH = "/v1/assistant_priest_history/{id}/"
