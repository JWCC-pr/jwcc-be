...
class WeeklyBulletinEditorialListAPITest(APITestCase):
    MODEL = WeeklyBulletinEditorial
    PATH = "/v1/weekly_bulletin_editorial/"
...
class WeeklyBulletinEditorialCreateAPITest(APITestCase):
    MODEL = WeeklyBulletinEditorial
    PATH = "/v1/weekly_bulletin_editorial/"
...
class WeeklyBulletinEditorialRetrieveAPITest(APITestCase):
    MODEL = WeeklyBulletinEditorial
    PATH = "/v1/weekly_bulletin_editorial/{id}/"
...
class WeeklyBulletinEditorialUpdateAPITest(APITestCase):
    MODEL = WeeklyBulletinEditorial
    PATH = "/v1/weekly_bulletin_editorial/{id}/"
...
class WeeklyBulletinEditorialDestroyAPITest(APITestCase):
    MODEL = WeeklyBulletinEditorial
    PATH = "/v1/weekly_bulletin_editorial/{id}/"
