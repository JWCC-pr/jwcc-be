...
class EventListAPITest(APITestCase):
    MODEL = Event
    PATH = "/v1/event/"
...
class EventCreateAPITest(APITestCase):
    MODEL = Event
    PATH = "/v1/event/"
...
class EventRetrieveAPITest(APITestCase):
    MODEL = Event
    PATH = "/v1/event/{id}/"
...
class EventUpdateAPITest(APITestCase):
    MODEL = Event
    PATH = "/v1/event/{id}/"
...
class EventDestroyAPITest(APITestCase):
    MODEL = Event
    PATH = "/v1/event/{id}/"
