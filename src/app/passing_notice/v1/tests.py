...
class PassingNoticeListAPITest(APITestCase):
    MODEL = PassingNotice
...
class PassingNoticeCreateAPITest(APITestCase):
    MODEL = PassingNotice
    PATH = "/v1/passing_notice/"
...
class PassingNoticeRetrieveAPITest(APITestCase):
    MODEL = PassingNotice
    PATH = "/v1/passing_notice/{id}/"
...
class PassingNoticeUpdateAPITest(APITestCase):
    MODEL = PassingNotice
    PATH = "/v1/passing_notice/{id}/"
...
class PassingNoticeDestroyAPITest(APITestCase):
    MODEL = PassingNotice
    PATH = "/v1/passing_notice/{id}/"
