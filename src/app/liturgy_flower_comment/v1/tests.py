...
class LiturgyFlowerCommentListAPITest(APITestCase):
    MODEL = LiturgyFlowerComment
    PATH = "/v1/liturgy_flower_comment/"
...
class LiturgyFlowerCommentCreateAPITest(APITestCase):
    MODEL = LiturgyFlowerComment
    PATH = "/v1/liturgy_flower_comment/"
...
class LiturgyFlowerCommentRetrieveAPITest(APITestCase):
    MODEL = LiturgyFlowerComment
    PATH = "/v1/liturgy_flower_comment/{id}/"
...
class LiturgyFlowerCommentUpdateAPITest(APITestCase):
    MODEL = LiturgyFlowerComment
    PATH = "/v1/liturgy_flower_comment/{id}/"
...
class LiturgyFlowerCommentDestroyAPITest(APITestCase):
    MODEL = LiturgyFlowerComment
    PATH = "/v1/liturgy_flower_comment/{id}/"
