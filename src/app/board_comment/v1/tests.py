...
class BoardCommentListAPITest(APITestCase):
    MODEL = BoardComment
    PATH = "/v1/board_comment/"
...
class BoardCommentCreateAPITest(APITestCase):
    MODEL = BoardComment
    PATH = "/v1/board_comment/"
...
class BoardCommentRetrieveAPITest(APITestCase):
    MODEL = BoardComment
    PATH = "/v1/board_comment/{id}/"
...
class BoardCommentUpdateAPITest(APITestCase):
    MODEL = BoardComment
    PATH = "/v1/board_comment/{id}/"
...
class BoardCommentDestroyAPITest(APITestCase):
    MODEL = BoardComment
    PATH = "/v1/board_comment/{id}/"
