...
class DepartmentListAPITest(APITestCase):
    MODEL = Department
    PATH = "/v1/department/"
...
class DepartmentCreateAPITest(APITestCase):
    MODEL = Department
    PATH = "/v1/department/"
...
class DepartmentRetrieveAPITest(APITestCase):
    MODEL = Department
...
class DepartmentUpdateAPITest(APITestCase):
    MODEL = Department
    PATH = "/v1/department/{id}/"
...
class DepartmentDestroyAPITest(APITestCase):
    MODEL = Department
    PATH = "/v1/department/{id}/"
