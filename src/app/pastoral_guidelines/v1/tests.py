...
class PastoralGuidelinesListAPITest(APITestCase):
    MODEL = PastoralGuidelines
    PATH = "/v1/pastoral_guidelines/"
...
class PastoralGuidelinesCreateAPITest(APITestCase):
    MODEL = PastoralGuidelines
    PATH = "/v1/pastoral_guidelines/"
...
class PastoralGuidelinesRetrieveAPITest(APITestCase):
    MODEL = PastoralGuidelines
    PATH = "/v1/pastoral_guidelines/{id}/"
...
class PastoralGuidelinesUpdateAPITest(APITestCase):
    MODEL = PastoralGuidelines
    PATH = "/v1/pastoral_guidelines/{id}/"
...
class PastoralGuidelinesDestroyAPITest(APITestCase):
    MODEL = PastoralGuidelines
    PATH = "/v1/pastoral_guidelines/{id}/"
