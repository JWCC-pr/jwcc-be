...
class LiturgyFlowerListAPITest(APITestCase):
    MODEL = LiturgyFlower
...
class LiturgyFlowerCreateAPITest(APITestCase):
    MODEL = LiturgyFlower
    PATH = "/v1/liturgy_flower/"
...
class LiturgyFlowerRetrieveAPITest(APITestCase):
    MODEL = LiturgyFlower
    PATH = "/v1/liturgy_flower/{id}/"
...
class LiturgyFlowerUpdateAPITest(APITestCase):
    MODEL = LiturgyFlower
    PATH = "/v1/liturgy_flower/{id}/"
...
class LiturgyFlowerDestroyAPITest(APITestCase):
    MODEL = LiturgyFlower
    PATH = "/v1/liturgy_flower/{id}/"
