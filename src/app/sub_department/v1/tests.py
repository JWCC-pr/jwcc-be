...
class SubDepartmentListAPITest(APITestCase):
    MODEL = SubDepartment
    PATH = "/v1/sub_department/"
...
class SubDepartmentCreateAPITest(APITestCase):
    MODEL = SubDepartment
    PATH = "/v1/sub_department/"
...
class SubDepartmentRetrieveAPITest(APITestCase):
    MODEL = SubDepartment
    PATH = "/v1/sub_department/{id}/"
...
class SubDepartmentUpdateAPITest(APITestCase):
    MODEL = SubDepartment
    PATH = "/v1/sub_department/{id}/"
...
class SubDepartmentDestroyAPITest(APITestCase):
    MODEL = SubDepartment
    PATH = "/v1/sub_department/{id}/"
