...
class DepartmentBoardLikeListAPITest(APITestCase):
    MODEL = DepartmentBoardLike
    PATH = "/v1/department_board_like/"
...
class DepartmentBoardLikeCreateAPITest(APITestCase):
    MODEL = DepartmentBoardLike
    PATH = "/v1/department_board_like/"
...
class DepartmentBoardLikeRetrieveAPITest(APITestCase):
    MODEL = DepartmentBoardLike
    PATH = "/v1/department_board_like/{id}/"
...
class DepartmentBoardLikeUpdateAPITest(APITestCase):
    MODEL = DepartmentBoardLike
    PATH = "/v1/department_board_like/{id}/"
...
class DepartmentBoardLikeDestroyAPITest(APITestCase):
    MODEL = DepartmentBoardLike
    PATH = "/v1/department_board_like/{id}/"
