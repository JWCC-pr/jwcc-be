...
class PastorHistoryListAPITest(APITestCase):
    MODEL = PastorHistory
...
class PastorHistoryCreateAPITest(APITestCase):
    MODEL = PastorHistory
    PATH = "/v1/pastor_history/"
...
class PastorHistoryRetrieveAPITest(APITestCase):
    MODEL = PastorHistory
    PATH = "/v1/pastor_history/{id}/"
...
class PastorHistoryUpdateAPITest(APITestCase):
    MODEL = PastorHistory
    PATH = "/v1/pastor_history/{id}/"
...
class PastorHistoryDestroyAPITest(APITestCase):
    MODEL = PastorHistory
    PATH = "/v1/pastor_history/{id}/"
