...
class BoardLikeListAPITest(APITestCase):
    MODEL = BoardLike
    PATH = "/v1/board_like/"
...
class BoardLikeCreateAPITest(APITestCase):
    MODEL = BoardLike
    PATH = "/v1/board_like/"
...
class BoardLikeRetrieveAPITest(APITestCase):
    MODEL = BoardLike
    PATH = "/v1/board_like/{id}/"
...
class BoardLikeUpdateAPITest(APITestCase):
    MODEL = BoardLike
    PATH = "/v1/board_like/{id}/"
...
class BoardLikeDestroyAPITest(APITestCase):
    MODEL = BoardLike
    PATH = "/v1/board_like/{id}/"
