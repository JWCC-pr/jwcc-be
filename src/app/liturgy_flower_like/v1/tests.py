...
class LiturgyFlowerLikeListAPITest(APITestCase):
    MODEL = LiturgyFlowerLike
    PATH = "/v1/liturgy_flower_like/"
...
class LiturgyFlowerLikeCreateAPITest(APITestCase):
    MODEL = LiturgyFlowerLike
    PATH = "/v1/liturgy_flower_like/"
...
class LiturgyFlowerLikeRetrieveAPITest(APITestCase):
    MODEL = LiturgyFlowerLike
    PATH = "/v1/liturgy_flower_like/{id}/"
...
class LiturgyFlowerLikeUpdateAPITest(APITestCase):
    MODEL = LiturgyFlowerLike
    PATH = "/v1/liturgy_flower_like/{id}/"
...
class LiturgyFlowerLikeDestroyAPITest(APITestCase):
    MODEL = LiturgyFlowerLike
    PATH = "/v1/liturgy_flower_like/{id}/"
