...
class LiturgyFlowerImageListAPITest(APITestCase):
    MODEL = LiturgyFlowerImage
    PATH = "/v1/liturgy_flower_image/"
...
class LiturgyFlowerImageCreateAPITest(APITestCase):
    MODEL = LiturgyFlowerImage
    PATH = "/v1/liturgy_flower_image/"
...
class LiturgyFlowerImageRetrieveAPITest(APITestCase):
    MODEL = LiturgyFlowerImage
    PATH = "/v1/liturgy_flower_image/{id}/"
...
class LiturgyFlowerImageUpdateAPITest(APITestCase):
    MODEL = LiturgyFlowerImage
    PATH = "/v1/liturgy_flower_image/{id}/"
...
class LiturgyFlowerImageDestroyAPITest(APITestCase):
    MODEL = LiturgyFlowerImage
    PATH = "/v1/liturgy_flower_image/{id}/"
