...
class EmailVerifierListAPITest(APITestCase):
    MODEL = EmailVerifier
...
class EmailVerifierCreateAPITest(APITestCase):
    MODEL = EmailVerifier
    PATH = "/v1/email_verifier/"
...
class EmailVerifierRetrieveAPITest(APITestCase):
    MODEL = EmailVerifier
    PATH = "/v1/email_verifier/{id}/"
...
class EmailVerifierUpdateAPITest(APITestCase):
    MODEL = EmailVerifier
    PATH = "/v1/email_verifier/{id}/"
...
class EmailVerifierDestroyAPITest(APITestCase):
    MODEL = EmailVerifier
    PATH = "/v1/email_verifier/{id}/"
