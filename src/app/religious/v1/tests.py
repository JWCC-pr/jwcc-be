...
class ReligiousListAPITest(APITestCase):
    MODEL = Religious
    PATH = "/v1/religious/"
...
class ReligiousCreateAPITest(APITestCase):
    MODEL = Religious
    PATH = "/v1/religious/"
...
class ReligiousRetrieveAPITest(APITestCase):
    MODEL = Religious
    PATH = "/v1/religious/{id}/"
...
class ReligiousUpdateAPITest(APITestCase):
    MODEL = Religious
    PATH = "/v1/religious/{id}/"
...
class ReligiousDestroyAPITest(APITestCase):
    MODEL = Religious
    PATH = "/v1/religious/{id}/"
