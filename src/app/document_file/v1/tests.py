...
class DocumentFileListAPITest(APITestCase):
    MODEL = DocumentFile
    PATH = "/v1/document_file/"
...
class DocumentFileCreateAPITest(APITestCase):
    MODEL = DocumentFile
    PATH = "/v1/document_file/"
...
class DocumentFileRetrieveAPITest(APITestCase):
    MODEL = DocumentFile
    PATH = "/v1/document_file/{id}/"
...
class DocumentFileUpdateAPITest(APITestCase):
    MODEL = DocumentFile
    PATH = "/v1/document_file/{id}/"
...
class DocumentFileDestroyAPITest(APITestCase):
    MODEL = DocumentFile
    PATH = "/v1/document_file/{id}/"
