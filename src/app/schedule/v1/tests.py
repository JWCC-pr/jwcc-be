...
class ScheduleListAPITest(APITestCase):
    MODEL = Schedule
    PATH = "/v1/schedule/"
...
class ScheduleRetrieveAPITest(APITestCase):
    MODEL = Schedule
    PATH = "/v1/schedule/{id}/"
...
class ScheduleUpdateAPITest(APITestCase):
    MODEL = Schedule
    PATH = "/v1/schedule/{id}/"
...
class ScheduleDestroyAPITest(APITestCase):
    MODEL = Schedule
    PATH = "/v1/schedule/{id}/"
