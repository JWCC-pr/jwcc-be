...
class DepartmentBoardImageListAPITest(APITestCase):
...
class DepartmentBoardImageCreateAPITest(APITestCase):
    MODEL = DepartmentBoardImage
    PATH = "/v1/department_board_image/"
...
class DepartmentBoardImageRetrieveAPITest(APITestCase):
    MODEL = DepartmentBoardImage
    PATH = "/v1/department_board_image/{id}/"
...
class DepartmentBoardImageUpdateAPITest(APITestCase):
    MODEL = DepartmentBoardImage
    PATH = "/v1/department_board_image/{id}/"
...
class DepartmentBoardImageDestroyAPITest(APITestCase):
    MODEL = DepartmentBoardImage
    PATH = "/v1/department_board_image/{id}/"
