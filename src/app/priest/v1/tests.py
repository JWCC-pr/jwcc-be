...
class PriestListAPITest(APITestCase):
    MODEL = Priest
    PATH = "/v1/priest/"
...
class PriestCreateAPITest(APITestCase):
    MODEL = Priest
    PATH = "/v1/priest/"
...
class PriestRetrieveAPITest(APITestCase):
    MODEL = Priest
    PATH = "/v1/priest/{id}/"
...
class PriestUpdateAPITest(APITestCase):
    MODEL = Priest
    PATH = "/v1/priest/{id}/"
...
class PriestDestroyAPITest(APITestCase):
    MODEL = Priest
    PATH = "/v1/priest/{id}/"
