...
@extend_schema_view(
    list=extend_schema(summary="ReligiousHistory 목록 조회"),
    create=extend_schema(summary="ReligiousHistory 등록"),
    update=extend_schema(summary="ReligiousHistory 수정"),
    partial_update=extend_schema(exclude=True),
    destroy=extend_schema(summary="ReligiousHistory 삭제"),
)
