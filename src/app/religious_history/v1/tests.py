...
class ReligiousHistoryListAPITest(APITestCase):
...
class ReligiousHistoryCreateAPITest(APITestCase):
    MODEL = ReligiousHistory
    PATH = "/v1/religious_history/"
...
class ReligiousHistoryRetrieveAPITest(APITestCase):
    MODEL = ReligiousHistory
    PATH = "/v1/religious_history/{id}/"
...
class ReligiousHistoryUpdateAPITest(APITestCase):
    MODEL = ReligiousHistory
    PATH = "/v1/religious_history/{id}/"
...
class ReligiousHistoryDestroyAPITest(APITestCase):
    MODEL = ReligiousHistory
    PATH = "/v1/religious_history/{id}/"
