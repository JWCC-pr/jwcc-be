...
class NoticeCreateAPITest(APITestCase):
    MODEL = Notice
    PATH = "/v1/notice/"
...
class NoticeRetrieveAPITest(APITestCase):
    MODEL = Notice
    PATH = "/v1/notice/{id}/"
...
class NoticeUpdateAPITest(APITestCase):
    MODEL = Notice
    PATH = "/v1/notice/{id}/"
...
class NoticeDestroyAPITest(APITestCase):
    MODEL = Notice
    PATH = "/v1/notice/{id}/"
