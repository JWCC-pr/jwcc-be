...
class BannerListAPITest(APITestCase):
    MODEL = Banner
    PATH = "/v1/banner/"
...
class BannerCreateAPITest(APITestCase):
    MODEL = Banner
    PATH = "/v1/banner/"
...
class BannerRetrieveAPITest(APITestCase):
    MODEL = Banner
    PATH = "/v1/banner/{id}/"
...
class BannerUpdateAPITest(APITestCase):
    MODEL = Banner
    PATH = "/v1/banner/{id}/"
...
class BannerDestroyAPITest(APITestCase):
    MODEL = Banner
    PATH = "/v1/banner/{id}/"
