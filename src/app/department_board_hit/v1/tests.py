...
class DepartmentBoardHitListAPITest(APITestCase):
...
class DepartmentBoardHitCreateAPITest(APITestCase):
    MODEL = DepartmentBoardHit
    PATH = "/v1/department_board_hit/"
...
class DepartmentBoardHitRetrieveAPITest(APITestCase):
    MODEL = DepartmentBoardHit
    PATH = "/v1/department_board_hit/{id}/"
...
class DepartmentBoardHitUpdateAPITest(APITestCase):
    MODEL = DepartmentBoardHit
    PATH = "/v1/department_board_hit/{id}/"
...
class DepartmentBoardHitDestroyAPITest(APITestCase):
    MODEL = DepartmentBoardHit
    PATH = "/v1/department_board_hit/{id}/"
