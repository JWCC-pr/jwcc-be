...
class BoardHitListAPITest(APITestCase):
    MODEL = BoardHit
    PATH = "/v1/board_hit/"
...
class BoardHitCreateAPITest(APITestCase):
    MODEL = BoardHit
    PATH = "/v1/board_hit/"
...
class BoardHitRetrieveAPITest(APITestCase):
    MODEL = BoardHit
    PATH = "/v1/board_hit/{id}/"
...
class BoardHitUpdateAPITest(APITestCase):
    MODEL = BoardHit
    PATH = "/v1/board_hit/{id}/"
...
class BoardHitDestroyAPITest(APITestCase):
    MODEL = BoardHit
    PATH = "/v1/board_hit/{id}/"
