...
class CatechismRoomListAPITest(APITestCase):
    MODEL = CatechismRoom
...
class CatechismRoomCreateAPITest(APITestCase):
    MODEL = CatechismRoom
    PATH = "/v1/catechism_room/"
...
class CatechismRoomRetrieveAPITest(APITestCase):
    MODEL = CatechismRoom
    PATH = "/v1/catechism_room/{id}/"
...
class CatechismRoomUpdateAPITest(APITestCase):
    MODEL = CatechismRoom
    PATH = "/v1/catechism_room/{id}/"
...
class CatechismRoomDestroyAPITest(APITestCase):
    MODEL = CatechismRoom
    PATH = "/v1/catechism_room/{id}/"
