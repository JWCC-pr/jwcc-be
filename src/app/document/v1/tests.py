...
class DocumentCreateAPITest(APITestCase):
    MODEL = Document
    PATH = "/v1/document/"
...
class DocumentRetrieveAPITest(APITestCase):
    MODEL = Document
    PATH = "/v1/document/{id}/"
...
class DocumentUpdateAPITest(APITestCase):
    MODEL = Document
    PATH = "/v1/document/{id}/"
...
class DocumentDestroyAPITest(APITestCase):
    MODEL = Document
    PATH = "/v1/document/{id}/"
