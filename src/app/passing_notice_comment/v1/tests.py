...
class PassingNoticeCommentListAPITest(APITestCase):
    MODEL = PassingNoticeComment
    PATH = "/v1/passing_notice_comment/"
...
class PassingNoticeCommentCreateAPITest(APITestCase):
    MODEL = PassingNoticeComment
    PATH = "/v1/passing_notice_comment/"
...
class PassingNoticeCommentRetrieveAPITest(APITestCase):
    MODEL = PassingNoticeComment
    PATH = "/v1/passing_notice_comment/{id}/"
...
class PassingNoticeCommentUpdateAPITest(APITestCase):
    MODEL = PassingNoticeComment
    PATH = "/v1/passing_notice_comment/{id}/"
...
class PassingNoticeCommentDestroyAPITest(APITestCase):
    MODEL = PassingNoticeComment
    PATH = "/v1/passing_notice_comment/{id}/"
